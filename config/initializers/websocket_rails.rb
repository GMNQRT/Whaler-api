WebsocketRails.setup do |config|
  ...
  # By default, WebsocketRails will attempt to connect to Redis on localhost:6379.
  # If you need to change this, you can set your redis host and port explicitly
